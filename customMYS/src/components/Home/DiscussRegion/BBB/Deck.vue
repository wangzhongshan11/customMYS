<template>
  <div>
    <topicPopup ref="dailyPopupIndex" :topic="BBBDeckTopics"></topicPopup>
    <div
      ...
      >
        <div class="swiper-wrapper">
          <div
            ...
            v-for="(item,index) in BBBDeckTopics"
            :key="index"
            style="width:auto;margin-right:0px;"
            @click="clickTopicSus(index)"
          >
            <span
              class="swiper-slide-deck-suspension"
      ...
      >
        ...
        >
          ...
          <span class="flex-div-end-wrap" style="height:23px;">
            ...
            <span style="margin-left:12%;" class="subscribe-article-wrap-deck">
...
export default {
  ...
  mounted() {
    this.loadPlateBlogs("甲板");
    this.loadPlateTopics("甲板");
  ...
  methods: {
    iniSubscribeButton() {
      if (isNotNullORBlank(this.articles)) {
        this.articles.forEach((item, index) => {
          ...
          if (
            ...
            console.log(index);
            console.log(
              document.getElementsByClassName("subscribe-article-wrap-deck")
            );
      ...
      if (this.chosenTopicIndex == 0) {
        ...
        document.getElementsByClassName("swiper-slide-deck")[0].style.color =
          "#fff";
        document.getElementsByClassName(
          "swiper-slide-deck-suspension"
        )[0].style.backgroundColor = "#000000";
        document.getElementsByClassName(
          "swiper-slide-deck-suspension"
        )[0].style.color = "#fff";
    ...
    clickTopic(ind) {
      var _this = this;
      if (this.BBBDeckTopics[ind].topicname !== "全部") {
        this.loadTopicBlogs(this.BBBDeckTopics[ind].topicname);
      ...
      var swiperSlideDailys = Array.from(
        document.getElementsByClassName("swiper-slide-deck")
      );
      var swiperSlideDailySuspensions = Array.from(
        document.getElementsByClassName("swiper-slide-deck-suspension")
      );
    ...
    initArticles() {
      ...
      if (isNotNullORBlank(stateArticles)) {
        stateArticles.forEach((item, index) => {
          var _this = this;
          if (stateArticles[index].platename == "甲板") {
