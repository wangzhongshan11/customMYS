  ...
  <div class="home-page-tran home-page-tran-search">
    <transition>
      <div
        ...
        style="background-color:#3399ff;opacity:1;z-index:89;"
      ...
      >
        ...
        <div class="scroll-region">
          <div style="padding-top:150px;background-color:#3399FF;padding-bottom:60px;">
            <div
              class="swiper-container swiper-container-home-yuanshen"
              ...
              <el-row @click="goDiscussRegion()" style="cursor:pointer;">
                ...
                <el-col :span="15" :offset="0">
                  <div style="height:70px;padding-top:0px;" @click="goDiscussRegion()">
                    <div class="flex-div-start-wrap" style="font-size:20px;">旅行者讨论区</div>
                    <div
...
export default {
  mounted() {
    new Swiper(".swiper-container-home-yuanshen", {
      slidesPerView: "4",
      freeMode: false,
    ...
    this.loadBlogs("原神");
    this.articles = this.$store.state.yuanShenArticles;
    console.log("homeYuanShen");
