      ...
      >
        ...
        <div class="scroll-region">
          <div style="padding-top:150px;background-color:#3399FF;padding-bottom:60px;">
            <div
              class="swiper-container swiper-container-home-bb"
              ...
              <el-row @click="goDiscussRegion()" style="cursor:pointer;">
                ...
                <el-col :span="15" :offset="0">
                  <div style="height:70px;padding-top:0px;" @click="goDiscussRegion()">
                    <div class="flex-div-start-wrap" style="font-size:20px;">崩坏学园2讨论区</div>
                    <div
...
export default {
  mounted() {
    new Swiper(".swiper-container-home-bb", {
      slidesPerView: "5",
      freeMode: false,
    ...
    this.articles = this.$store.state.BBArticles;
    console.log("homeBB");
  ...
  data() {
    return {
      ...
      articles: [],
      homeSwipers: ["同人图", "活动", "反馈", "百宝箱", "四格漫画"],
    };
  },
  methods: {
    goDiscussRegion() {
